...
CREATE TABLE IF NOT EXISTS `scoa`.`student_class` (
  ...
  PRIMARY KEY (`student_id`, `class_id`, `period`),
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `scoa`.`complaint_suggestion` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `complaint_or_suggestion` TINYINT NOT NULL COMMENT 'SUGESTAO = 0\nRECLAMACAO = 1',
  `text` TEXT NOT NULL,
  `student_id` INT(11) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_complaint_suggestion_student1_idx` (`student_id` ASC),
  CONSTRAINT `fk_complaint_suggestion_student1`
    FOREIGN KEY (`student_id`)
    REFERENCES `scoa`.`student` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
