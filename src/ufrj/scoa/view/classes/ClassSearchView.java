...
public class ClassSearchView extends JPanel {
	...
	private void populateComboBoxes() {
		...
		cbCourse.addItem(new Course("Selecione um curso", "", ""));
		for(Course c : coursesList) {
			cbCourse.addItem(c);
		}
		
		cbRoom.addItem(new Room("Selecione uma sala", 0,0));
		for(Room r : roomsList) {
			cbRoom.addItem(r);
		}
		
		cbDiscipline.addItem(new Discipline("Selecione uma disciplina", "", ""));
