...
public class ProfessorListView extends JPanel {
	...
	public ProfessorListView() {
		...
		professorModel.addColumn("Email");
		
		table = new JTable(professorModel);
		...
		JLabel lblAlunosCadastrados = new JLabel("PROFESSORES CADASTRADOS");
	...
	public DefaultTableModel getProfessorModel() {
